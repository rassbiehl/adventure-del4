...
public class Map {
    ...
    public void buildWorld() {
        ...
        Item potion = new Item("Potion", "a health potion");
        Item boots = new Item("Boots", "boots");
        ...
        MeleeWeapon sword = new MeleeWeapon("Sword", "a long sword 🗡️");
        RangedWeapon awp = new RangedWeapon("Sniper rifle", "a hunting rifle with scope. 3 bullets", 3); //imagine if i made a subclass of rangedWeapon
        //called rifle or pistol that could reload bullets with magazine as an arraylist. cool.
        room1.addRoomItems(compass);
        room3.addRoomItems(book);
        room5.addRoomItems(boots);
        room7.addRoomItems(potion);
        room2.addRoomItems(apple);
        room3.addRoomItems(cake);
        room3.addRoomItems(casinoKey);
        room1.addRoomItems(sword);
        room1.addRoomItems(awp);
    }
